...
const config = {
    title: 'Documentação Acesso Cidadão',
    tagline: 'Documentação do Acesso Cidadão, login único do Estado do Espírito Santo',
    ...
    themeConfig:
        ...
        ({
            ...
            footer: {
                ...
                links: [
                    {
                        label: 'Acesso Cidadão',
                        href: 'https://acessocidadao.es.gov.br/',
                    },
                ],
